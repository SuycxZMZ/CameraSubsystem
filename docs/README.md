...
| [TARGET_DETECTION_PIPELINE_DESIGN.md](TARGET_DETECTION_PIPELINE_DESIGN.md) | 目标检测服务架构，包含 `camera_detection_server`、RKNN NPU core mask、DetectionResult 契约、Web 检测开关/状态链路和当前 P0 收敛设计 | RKNN host 工具链安装细节、训练流程、LLM 路线 |

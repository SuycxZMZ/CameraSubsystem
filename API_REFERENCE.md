...
- [2. 数据结构接口](#2-数据结构接口)
- [3. 回调接口](#3-回调接口)
- [4. CameraSource 类接口](#4-camerasource-类接口)
- [5. FrameBroker 类接口](#5-framebroker-类接口)
- [6. PlatformThread 类接口](#6-platformthread-类接口)
- [7. PlatformEpoll 类接口](#7-platformepoll-类接口)
- [8. PlatformLogger 类接口](#8-platformlogger-类接口)
- [9. 日志宏定义](#9-日志宏定义)
- [10. 常量定义](#10-常量定义)
- [11. 辅助函数](#11-辅助函数)
- [12. 版本信息](#12-版本信息)
